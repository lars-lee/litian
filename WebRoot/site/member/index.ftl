...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-8 blog-main">
            <div>
                <a class="blog-post-title" href="${contextPath}/articles">文章</a>
                <a class="blog-post-title" href="#">照片</a>
                <a class="blog-post-title" href="#">游戏</a>
                <a class="blog-post-title" href="${contextPath}/helper/pwd">工具</a>
            </div>
            <nav>
                <ul class="pager">
                    <li><a href="#">上一页</a></li>
